...
<body>
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<c:set var="contextPath" value="${pageContext.request.contextPath}" />
			<div class="container">
				<form action="${contextPath}/restaurant/updateMenu.htm" method="POST" class="form-horizontal">
					<div class="form-group">
		                <label class="col-lg-3 control-label">Menu Name:</label>
		                <div class="col-lg-5">
		                    <input type="text" class="form-control" name="name" value="${sessionScope.menu.name}"
		            ...
		            <div class="form-group">
		                ...
		                <div class="col-lg-5">
		                    <input type="text" class="form-control" name="price" value="${sessionScope.menu.price}"
		            ...
		            <div class="form-group">
		                ...
		                <div class="col-lg-5">
		                    <input type="text" class="form-control" name="stock" value="${sessionScope.menu.stock}"
