...
<body>
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<c:set var="contextPath" value="${pageContext.request.contextPath}" />
			<form action="${contextPath}/restaurant/updateMenu.htm" method="POST">
				<table>
					<tr>
					    <td>Menu Name:</td>
					    <td><input type="text" name="name" size="30" required="required" value="${sessionScope.menu.name}" /></td>
					</tr>
					<tr><td></td><td></td></tr>
					<tr>
					    <td>Price:</td>
					    <td><input type="text" name="price" size="30" required="required" value="${sessionScope.menu.price}" /></td>
					</tr>
					<tr><td></td><td></td></tr>
					<tr>
					    <td>Stock:</td>
					    <td><input type="text" name="stock" size="30" required="required" value="${sessionScope.menu.stock}" /></td>
					</tr>
					<tr><td></td><td></td></tr>
					<tr>
